...
class SolusiKondensorPage extends StatelessWidget {
  final int masalah, penyebab;
  const SolusiKondensorPage(
    ...
    return Scaffold(
      ...
      body: Container(
        child: ListView.builder(
          shrinkWrap: true,
          itemCount: dataKondensor[masalah].tiles[penyebab].tiles.length,
